 ...
 * test slowdown for creating a browser instance for each class with tests.
 *
...
public class Driver extends Thread{
    ...
    public static WebDriver get() {
        ...
        if(useThisDriver == null){
            ...
            // see the package com.seleniumsimplified.webdriver.drivers;
        ...
        if(aDriver==null){
            ...
            // These settings are subject to the specific requirements for driver
